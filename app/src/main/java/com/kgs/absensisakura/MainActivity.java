...
import com.kgs.absensisakura.Absensi.AbsensiFragment;
import com.kgs.absensisakura.Absensi.ExportFragment;
import com.kgs.absensisakura.Absensi.MasterDataFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Icon pojok
        //getSupportActionBar().setHomeAsUpIndicator(R.drawable.logoskr);// set drawable icon
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                new MasterDataFragment()).commit();

        //BackPress settings for Fragment
        getSupportFragmentManager().beginTransaction()
                .setReorderingAllowed(true)
                .add(R.id.fragment_container, MasterDataFragment.class, null)
                .commit();
        requestPermission();
        ...
        bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            switch (item.getItemId()) {
                case R.id.menu_home:
                    selectedFragment = new MasterDataFragment();
                    myToolbar.setTitle("Master Data");
                    break;

                case R.id.menu_piutang:
                    selectedFragment = new AbsensiFragment();
                    myToolbar.setTitle("Absensi Karyawan");
                    break;
